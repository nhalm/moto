...
Why jj:
- Working copy is always a commit (Claude's changes auto-tracked)
- Easy to squash/reorganize before promoting
- Automatic rebasing
- Git-compatible (repo stays git, jj operates on it)
