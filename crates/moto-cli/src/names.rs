...
const ADJECTIVES: &[&str] = &[
    ...
    "fancy", "fast", "fierce", "gentle", "golden", "grand", "happy", "keen",
    "kind", "lively", "lucky", "merry", "mighty", "noble", "proud", "quick",
    "quiet", "rapid", "sharp", "shiny", "silent", "sleek", "smart", "smooth",
    "snappy", "solid", "speedy", "steady", "strong", "super", "swift", "tough",
    "vivid", "warm", "wild", "wise", "witty", "zesty",
];

/// Animals for name generation.
const ANIMALS: &[&str] = &[
    "badger", "bear", "beaver", "buffalo", "camel", "cat", "cheetah", "cobra",
    "condor", "cougar", "coyote", "crane", "crow", "deer", "dingo", "dolphin",
    "eagle", "falcon", "ferret", "finch", "fox", "gecko", "goat", "goose",
    "gorilla", "gull", "hawk", "heron", "horse", "husky", "iguana", "jackal",
    "jaguar", "jay", "koala", "lemur", "leopard", "lion", "llama", "lynx",
    "mantis", "marten", "mongoose", "moose", "mouse", "newt", "otter", "owl",
    "panda", "panther", "parrot", "penguin", "pigeon", "puma", "python", "rabbit",
    "raven", "salmon", "seal", "shark", "snake", "spider", "squirrel", "stork",
    "swan", "tiger", "toucan", "turtle", "viper", "walrus", "weasel", "whale",
    "wolf", "wombat", "zebra",
];
